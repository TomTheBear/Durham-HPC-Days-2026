...
permalink: /programme-hpcdays-2026/
classes: [full-programme]
---

{% assign all_sessions = site.programme
...
<div class="programme-disclaimer">
  Please note that this programme is still a draft. Sessions are currently being arranged and new sessions may be added or moved as the schedule is finalised.
</div>
...
{% assign tbd_titles = "TUTORIAL TBD|WORKSHOP TBD|TALKS TBD|MEETING TBD|KEYNOTE TBD" | split: "|" %}
{% assign is_tbd = false %}
...
<div class="session-card {{ s.category | downcase }} {% if is_tbd %}tbd{% endif %}">
<h3>
  {% if s.track %}{% endif %}
  {{ s.title }}
</h3>
